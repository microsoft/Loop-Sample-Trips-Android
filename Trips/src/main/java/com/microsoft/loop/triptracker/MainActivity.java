...
public class MainActivity extends AppCompatActivity
        ...
        locationSwitch.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    SampleAppApplication.instance.enableLocationTracking();
                } else {
                    SampleAppApplication.instance.disableLocationTracking();
                }
                    ...
                    public void onClick(DialogInterface dialog, int id) {
                        ...
                        LoopSDK.deleteUser(new ILoopServiceCallback<Void>() {
                            ...
                            public void onError(LoopError error) {
                                runOnUiThread(new Runnable() {
                                    public void run(){
                                    Toast.makeText(MainActivity.this,"Failed to delete trips",
    ...
    public void checkTrackingEnabled() {
      ...
      //  locationText.setText(tracking ? getResources().getString(R.string.trips_recording_on) : getResources().getString(R.string.trips_recording_off));
